...
-- Add triggers to log sensitive data access attempts
...
DROP TRIGGER IF EXISTS audit_reports_access ON public.reports;
CREATE TRIGGER audit_reports_access
  AFTER SELECT ON public.reports
  FOR EACH ROW
  EXECUTE FUNCTION audit_reports_access();
